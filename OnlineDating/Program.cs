...
users.Add(new User("Charles", "New", Sex.Male, new DateTime(1958, 6, 25), EyeColor.Green, HairColor.Blonde));
...
users.Add(new User("Lucy", "Novak", Sex.Female, new DateTime(1978, 10, 2), EyeColor.Cyan, HairColor.Blonde));
users.Add(new User("Simon", "Young", Sex.Female, new DateTime(1968, 1, 8), EyeColor.NotSpecified, HairColor.Brown));
users.Add(new User("Michael", "Futigue", Sex.Female, new DateTime(1958, 12, 6), EyeColor.Blue, HairColor.Redhead));
